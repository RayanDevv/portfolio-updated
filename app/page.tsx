        ...
        <section id="expertise" className="py-24 bg-black/60 border-t border-stone-900 px-6 backdrop-blur-md">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="relative group"><span className="absolute -left-[53px] top-2 h-3 w-3 rounded-full bg-stone-800 group-hover:bg-[#c0b283] transition-colors ring-4 ring-black"></span><h3 className="text-xl text-white font-normal uppercase tracking-wide group-hover:text-[#c0b283] transition-colors">Assistant Comptable <span className="text-[#c0b283] text-sm lowercase ml-2">/ Alternance</span></h3><p className="text-stone-500 text-xs uppercase tracking-widest mb-4">2024 - 2025 • Oxiproteomics</p><p className="text-stone-400 font-light leading-relaxed">Gestion de la comptabilité tiers (clients et fournisseurs) et assistance à la révision comptable</p></motion.div>
              <motion.div variants={fadeInUp} className="relative group"><span className="absolute -left-[53px] top-2 h-3 w-3 rounded-full bg-stone-800 group-hover:bg-[#c0b283] transition-colors ring-4 ring-black"></span><h3 className="text-xl text-white font-normal uppercase tracking-wide group-hover:text-[#c0b283] transition-colors">Contrôleur de gestion <span className="text-[#c0b283] text-sm lowercase ml-2">/ Stage</span></h3><p className="text-stone-500 text-xs uppercase tracking-widest mb-4">05/2024 - 07/2024 • RATP</p><p className="text-stone-400 font-light leading-relaxed">Analyse des écarts (prix/volume) et automatisation du suivi des investissements en temps réel via Excel...</p></motion.div>
              <motion.div variants={fadeInUp} className="relative group"><span className="absolute -left-[53px] top-2 h-3 w-3 rounded-full bg-stone-800 group-hover:bg-[#c0b283] transition-colors ring-4 ring-black"></span><h3 className="text-xl text-white font-normal uppercase tracking-wide group-hover:text-[#c0b283] transition-colors">Développeur Freelance <span className="text-[#c0b283] text-sm lowercase ml-2">/ Freelance</span></h3><p className="text-stone-500 text-xs uppercase tracking-widest mb-4">Depuis 2021 • RYN</p><p className="text-stone-400 font-light leading-relaxed">Création de sites sur-mesure (Premier client : Artisan Plombier) et optimisation SEO.</p></motion.div>
            </motion.div>
          </div>
        </section>
